...
CREATE TABLE `alumnos_comisiones` (
  `id_alumnos_comisiones` int NOT NULL AUTO_INCREMENT,
  `id_libreta` int NOT NULL,
  `id_codigo` int NOT NULL,
  PRIMARY KEY (`id_alumnos_comisiones`),
...
INSERT INTO `alumnos_comisiones` VALUES (1,1,1),(2,1,3),(3,2,4),(4,3,6);
...
CREATE TABLE `alumnos_materias` (
  ...
  PRIMARY KEY (`id_alumnos_materias`),
...
INSERT INTO `alumnos_materias` VALUES (1,1,1),(2,1,2),(3,2,2),(4,3,3);
...
INSERT INTO `asignatura` VALUES (1,'ANALISIS MATEMATICO 1',10),(2,'LOGICA',10),(3,'ANALISIS MATEMATICO 2',10);
...
INSERT INTO `comisiones` VALUES (1,1,1,'1'),(2,0,2,'1'),(3,1,1,'2'),(4,1,2,'2'),(5,0,1,'3'),(6,1,2,'3');
...
CREATE TABLE `profes_materias` (
  `id_profes_materias` int NOT NULL AUTO_INCREMENT,
  `id_profesores` int NOT NULL,
  `id_materias` int NOT NULL,
  PRIMARY KEY (`id_profes_materias`),
...
INSERT INTO `profes_materias` VALUES (1,1,1),(2,1,3),(3,2,2),(4,3,3);
...
-- Dump completed on 2023-07-15 20:44:58
