...
CREATE TABLE `cursos` (
  ...
  UNIQUE KEY `idcursos_UNIQUE` (`id_codigo`),
...
CREATE TABLE `cursos_materias` (
  ...
  `ids_materias` int NOT NULL,
  PRIMARY KEY (`id_curso`),
  KEY `id_materia_idx` (`ids_materias`),
  CONSTRAINT `id_curso` FOREIGN KEY (`id_curso`) REFERENCES `cursos` (`id_codigo`),
  CONSTRAINT `id_materia` FOREIGN KEY (`ids_materias`) REFERENCES `materias` (`id_materia`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-29 21:48:50
